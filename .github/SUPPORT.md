# Getting help with covid19viz

Thanks for using covid19viz. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/covid19viz/issues) to make sure the 
